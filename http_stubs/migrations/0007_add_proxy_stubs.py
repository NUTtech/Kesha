# Generated by Django 3.1.13 on 2021-10-14 19:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_method', models.CharField(blank=True, choices=[('GET', 'Get'), ('POST', 'Post'), ('PUT', 'Put'), ('PATCH', 'Patch'), ('DELETE', 'Delete'), ('HEAD', 'Head'), ('OPTIONS', 'Options'), ('TRACE', 'Trace')], default='', max_length=10, verbose_name='Target request method')),
